...
const Posting = () => {
  ...
  console.log('Station Detail:: ', listParams, cntryParams);
  ...
  if ('text' in correspondData == true) { //fic
    ...
    let code = "<img src='/assets/img/art/" + correspondData.art + "' class='imgCntn' alt='content art' onclick='window.open(this.src)'/>"
    return field = ( 
